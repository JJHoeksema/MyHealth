...
// Mode of payment
    function addReglement( $mode )
    {
        ...
        $this->SetFont( "Arial", "B", 10);
        $this->Cell(10,4, "BETAAL METHODE", 0, 0, "C");
...
// Expiry date
    function addEcheance( $date )
    {
        ...
        $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
        $this->SetFont( "Arial", "B", 10);
        $this->Cell(10,4, "AFSCHRIJFDATUM", 0, 0, "C");
        $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
        $this->SetFont( "Arial", "", 10);
        $this->Cell(10,5,$date, 0,0, "C");
    }
...
// VAT number
    function addNumTVA($tva)
    {
        ...
        $this->Cell(40, 4, "FACTUURNUMMER", '', '', "C");
        $this->SetFont( "Arial", "", 10);
    ...
    {
        $this->SetFont( "Arial", "", 10);
        $length = $this->GetStringWidth( "REFERENTIE : " . $ref );
        $r1  = 10;
        $r2  = $r1 + $length;
        $y1  = 92;
        $y2  = $y1+5;
        $this->SetXY( $r1 , $y1 );
        $this->Cell($length,4, "REFERENTIE : " . $ref);
    }
